                                  ...
                                  size_t size)
{
    ...
    /* Frame length in the low half, buffer length stays in the high. */
                             ...
                             unsigned size)
{
    ...
    case SH7764_ETH_TRSCER:
        s->trscer = val;
        break;
    case SH7764_ETH_ECMR:
        s->ecmr = val;
        break;
    case SH7764_ETH_RFLR:
        s->rflr = val;
        break;
    ...
    case SH7764_ETH_ECSIPR:
        ...
        sh7764_eth_update_irq(s);
        break;
    case SH7764_ETH_MAHR:
        s->mahr = val;
        break;
    case SH7764_ETH_MALR:
        s->malr = val;
        break;
