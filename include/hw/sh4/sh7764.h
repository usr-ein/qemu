...
#define SH7764_PTDAT_C          0x0048      /* port C data; PTC2 gates the    */
#define SH7764_PTDAT_C_PTC2     (1u << 2)   /* GUI link, see sh7764_bank_read */
...
struct SH7764State {
    ...
    uint32_t ssi_rx_len;
    bool ssi_rx_armed;
    bool ssi_gui_answered;              /* stands in for PTC2; see the    */
                                        /* note above sh7764_bank_read    */
